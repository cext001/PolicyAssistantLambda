                ...
                if (error) {
                    ...
                    if (body.error) {
                        ...
                        if (body.result.bookingStatus) {
                            ...
                            speechOutput += '<s> The car will be delivered on ' + month + '<say-as interpret-as="ordinal">' + rentStartDate.getDate();
                            ...
                            speechOutput += '<s> <break strength=\"medium\" /> Do you want to book one? </s>';
                        }
                    }
